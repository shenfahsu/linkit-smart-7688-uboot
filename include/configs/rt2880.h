...
//CONFIG_INCA_IP
#if defined (RT3052_FPGA_BOARD) || defined (RT3352_FPGA_BOARD) || defined (RT2883_FPGA_BOARD) || defined (RT3883_FPGA_BOARD) || defined (RT5350_FPGA_BOARD) || defined (RT6855_FPGA_BOARD) || defined (MT7620_FPGA_BOARD) || defined (MT7621_FPGA_BOARD) || defined (RT6855A_FPGA_BOARD) || defined (MT7628_FPGA_BOARD)
...
#else
	#define CPU_CLOCK_RATE	FPGA_BOARD_CLOCK_RATE
#endif
...
#define CONFIG_SERVERIP		192.168.100.182
#define CONFIG_IPADDR		192.168.100.140
#define CONFIG_ETHADDR		"00:26:FC:76:88:10"
/* valid baudrates */
...
#if defined (RT6855A_FPGA_BOARD) || defined (RT6855A_ASIC_BOARD) || defined (MT7621_FPGA_BOARD) || defined (MT7621_ASIC_BOARD) || defined (MT7628_FPGA_BOARD) || defined (MT7628_ASIC_BOARD)
